...
\begin{frame}[fragile]{\myframetitle}
	\begin{fancycolumns}[widths={50}]
		\begin{exampletight}{Tree structure of $(5 + ln(50)) * 1.73$}
			\centering
			  \begin{tikzpicture}
				\node (1) {$*$};
				\node (2) [below left = 1cm and 1.2cm of 1]  {$+$};
				\node (3) [below right = 1cm and 1.2cm of 1] {$1.73$};
				\node (4) [below left = 1cm and 1.2cm of 2] {$5$};
				\node (5) [below right = 1cm and 1.2cm of 2] {$ln$};
				\node (6) [below = 1cm of 5] {$50$};
