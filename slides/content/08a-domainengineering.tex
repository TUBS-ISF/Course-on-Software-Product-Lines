...
\begin{frame}[t,label=DomainAndApplicationEngineeringDiagram]{Domain and Application Engineering}
	\vspace{-16pt}
...
\begin{frame}{Domain and Application Analysis}\small
	...
	\nextcolumn
		\begin{definition}{Domain Analysis\mysource{\fospl\mypage{21}, \sple\mypage{25}}}
			\begin{itemize}
				\item \textbf{requirements} analysis for a product line
				\item define \textbf{scope} of the product line
				\item which \textbf{features} are in scope?
				\item which \textbf{combinations of features} are in scope?
				\item[$\Rightarrow$] typically results in a \textbf{feature model} and features mapped to requirements
			\end{itemize}
		\end{definition}
...
\begin{frame}{Domain Scoping in Practice}
	...
	\nextcolumn
		...
		\begin{example}{Aygo Mirror Covers}
			...
			\begin{itemize}
				\item<2-> mirror covers? Yes!
				\item<3-> different covers for left and right side? Yes!
				\item<4-> multiple covers for the same side? Yes!
				\item<5-> between 2, 3, 4, \ldots\ colors and which ones?
			\end{itemize}
		\end{example}
	\end{fancycolumns}
\end{frame}
...
\begin{frame}{Domain and Application Design}
	...
	\nextcolumn
		\begin{definition}{Domain Design\mysource{\sple\mypage{26}}} % TODO see \sple Chapter 6+11
			\begin{itemize}
				\item development of a \textbf{reference architecture} (e.g., client-server or pipe-and-filter)
				\item common, high-level structure for all products
				\item decision on \textbf{implementation technique}
					\begin{itemize}
...
\begin{frame}{Domain and Application Implementation}
	...
	\nextcolumn
		\begin{definition}{Domain Implementation\mysource{\fospl\mypage{21}}} % TODO see \sple Chapter 7+12
			\begin{itemize}
				\item development of \textbf{reusable artifacts}
